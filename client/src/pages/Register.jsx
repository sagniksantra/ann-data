  ...
  return (
    ...
    <div className="bg-[#F5EEC8] min-h-screen flex items-center justify-center">
      <div className="w-full md:w-3/5 p-6 bg-[#F5EEC8] rounded-md">
        <h1 className="text-2xl font-bold mb-4 text-center">Farmer Details</h1>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="landAmount" className="block text-gray-700">Amount of Land (in acres):</label>
            <input
              type="number"
              id="landAmount"
              name="landAmount"
          ...
          <div className="mb-4">
            <label htmlFor="familyIncome" className="block text-gray-700">Family Income (per year):</label>
            <input
              type="number"
              id="familyIncome"
              name="familyIncome"
          ...
          <div className="mb-4">
            <label htmlFor="education" className="block text-gray-700">Education Level:</label>
            <input
              type="text"
              id="education"
              name="education"
          ...
          <div className="mb-4">
            <label htmlFor="farmingExperience" className="block text-gray-700">Farming Experience (in years):</label>
            <input
              type="number"
